...
// alef:hash:32cfc3720d274e22d3d1d56efe26f3494bee838091c1478ee881fa1e74e4e672
...
namespace Kreuzberg
{
    ...
    Assert.True(result.Content.Length >= 50, "expected length >= 50");
        ...
        public async Task Test_AsyncExtractBytesEmptyMime()
        {
            ...
            {
                await KreuzbergLib.ExtractBytesAsync(System.IO.File.ReadAllBytes("text/plain.txt"), "", new ExtractionConfig());
            });
        }
        ...
        public async Task Test_AsyncExtractBytesInvalidMime()
        {
            ...
            await Assert.ThrowsAnyAsync<KreuzbergException>(async () =>
            {
                await KreuzbergLib.ExtractBytesAsync(System.IO.File.ReadAllBytes("text/plain.txt"), "application/x-nonexistent", new ExtractionConfig());
            });
        }
