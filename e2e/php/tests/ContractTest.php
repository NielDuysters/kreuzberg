...
// alef:hash:4338915c202c1f4060456aaa79e21daa81ba6cc087dc754b9046c8178b775ede
...
final class ContractTest extends TestCase
{
    ...
    {        $result = Kreuzberg::extractFile("pdf/fake_memo.pdf", null, ExtractionConfig::from_json('{}'));
    ...
    {        $config = ExtractionConfig::from_json(json_encode(["chunking" => ["chunkerType" => "markdown", "maxChars" => 300, "maxOverlap" => 50, "prependHeadingContext" => true]]));
        ...
        $this->assertTrue(array_reduce($result->chunks ?? [], fn($carry, $c) => $carry && !empty($c->content), true));        // skipped: field 'chunks_have_heading_context' not available on result type        // skipped: field 'first_chunk_starts_with_heading' not available on result type
    }
