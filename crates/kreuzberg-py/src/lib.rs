...
// alef:hash:5c18720587eedae0cf9f29cf942a042a22fdb8fd24090eeedd9dcef84dded849
...
impl FormatMetadata {
    ...
    fn docx(&self) -> Option<DocxMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Docx(data) => Some(DocxMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn excel(&self) -> Option<ExcelMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Excel(data) => Some(ExcelMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn email(&self) -> Option<EmailMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Email(data) => Some(EmailMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn pptx(&self) -> Option<PptxMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Pptx(data) => Some(PptxMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn archive(&self) -> Option<ArchiveMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Archive(data) => Some(ArchiveMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn xml(&self) -> Option<XmlMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Xml(data) => Some(XmlMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn text(&self) -> Option<TextMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Text(data) => Some(TextMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn html(&self) -> Option<HtmlMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Html(data) => Some(HtmlMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn ocr(&self) -> Option<OcrMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Ocr(data) => Some(OcrMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn csv(&self) -> Option<CsvMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Csv(data) => Some(CsvMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn bibtex(&self) -> Option<BibtexMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Bibtex(data) => Some(BibtexMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn citation(&self) -> Option<CitationMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Citation(data) => Some(CitationMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn fiction_book(&self) -> Option<FictionBookMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::FictionBook(data) => Some(FictionBookMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn dbf(&self) -> Option<DbfMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Dbf(data) => Some(DbfMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn jats(&self) -> Option<JatsMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Jats(data) => Some(JatsMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn epub(&self) -> Option<EpubMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Epub(data) => Some(EpubMetadata::from(data.clone())),
            _ => None,
        }
    }
    ...
    fn pst(&self) -> Option<PstMetadata> {
        match &self.inner {
            kreuzberg::FormatMetadata::Pst(data) => Some(PstMetadata::from(data.clone())),
            _ => None,
        }
    }
