...
// alef:hash:22571cc0f5289f844806614e18c834a57a6178a9de16c0ec0cd8e51db2486049
...
final class Kreuzberg
{
    ...
    {
        return \Kreuzberg\KreuzbergApi::extractBytesAsync($content, $mime_type, $config ?? new ExtractionConfig()); // delegate to native extension class
    }
    ...
    {
        return \Kreuzberg\KreuzbergApi::extractFileAsync($path, $mime_type, $config ?? new ExtractionConfig()); // delegate to native extension class
    }
    ...
    {
        return \Kreuzberg\KreuzbergApi::batchExtractFilesAsync($items, $config ?? new ExtractionConfig()); // delegate to native extension class
    }
    ...
    {
        return \Kreuzberg\KreuzbergApi::batchExtractBytesAsync($items, $config ?? new ExtractionConfig()); // delegate to native extension class
    }
    ...
    {
        return \Kreuzberg\KreuzbergApi::embedTextsAsyncAsync($texts, $config ?? new EmbeddingConfig()); // delegate to native extension class
    }
