...
Future<List<Float64List>>  embedTexts({required List<String> texts , required EmbeddingConfig config }) => RustLib.instance.api.crateEmbedTexts(texts: texts, config: config);
...
Future<EmbeddingBackendDartImpl>  createEmbeddingBackendDartImpl({required String pluginName , required String pluginVersion , required BoxFnDartFnFutureI64 dimensions , required BoxFnVecStringDartFnFutureVecVecF64 embed }) => RustLib.instance.api.crateCreateEmbeddingBackendDartImpl(pluginName: pluginName, pluginVersion: pluginVersion, dimensions: dimensions, embed: embed);
                ...
                abstract class BoxFnDartFnFutureProcessingStage implements RustOpaqueInterface {
                ...
                abstract class BoxFnExtractionResultDartFnFutureI64 implements RustOpaqueInterface {
                ...
                abstract class BoxFnExtractionResultExtractionConfigDartFnFuture implements RustOpaqueInterface {
                ...
                abstract class BoxFnExtractionResultExtractionConfigDartFnFutureBool implements RustOpaqueInterface {
                ...
                abstract class BoxFnStringOcrConfigDartFnFutureExtractionResult implements RustOpaqueInterface {
                ...
                abstract class BoxFnVecStringDartFnFutureVecVecF64 implements RustOpaqueInterface {
                ...
                abstract class BoxFnVecU8OcrConfigDartFnFutureExtractionResult implements RustOpaqueInterface {
...
@freezed
 ...
 const factory AnnotationKind.link({   required String url ,  required String title , }) = AnnotationKind_Link;
 const factory AnnotationKind.highlight() = AnnotationKind_Highlight;
 const factory AnnotationKind.color({   required String value , }) = AnnotationKind_Color;
 const factory AnnotationKind.fontSize({   required String value , }) = AnnotationKind_FontSize;
 const factory AnnotationKind.custom({   required String name ,  required String value , }) = AnnotationKind_Custom;
...
final HeadingContext? headingContext;
                ...
                const ChunkMetadata({required this.byteStart ,required this.byteEnd ,this.tokenCount ,required this.chunkIndex ,required this.totalChunks ,this.firstPage ,this.lastPage ,this.headingContext ,});
        ...
        @override
        int get hashCode => byteStart.hashCode^byteEnd.hashCode^tokenCount.hashCode^chunkIndex.hashCode^totalChunks.hashCode^firstPage.hashCode^lastPage.hashCode^headingContext.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ChunkMetadata &&
                runtimeType == other.runtimeType
                && byteStart == other.byteStart&& byteEnd == other.byteEnd&& tokenCount == other.tokenCount&& chunkIndex == other.chunkIndex&& totalChunks == other.totalChunks&& firstPage == other.firstPage&& lastPage == other.lastPage&& headingContext == other.headingContext;
...
@freezed
 ...
 const factory ChunkSizing.tokenizer({   required String model ,  required String cacheDir , }) = ChunkSizing_Tokenizer;
...
final List<String> attributes;
                ...
                const DjotContent({required this.plainText ,required this.blocks ,required this.metadata ,required this.tables ,required this.images ,required this.links ,required this.footnotes ,required this.attributes ,});
        ...
        @override
        int get hashCode => plainText.hashCode^blocks.hashCode^metadata.hashCode^tables.hashCode^images.hashCode^links.hashCode^footnotes.hashCode^attributes.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is DjotContent &&
                runtimeType == other.runtimeType
                && plainText == other.plainText&& blocks == other.blocks&& metadata == other.metadata&& tables == other.tables&& images == other.images&& links == other.links&& footnotes == other.footnotes&& attributes == other.attributes;
...
final String? attributes;
                ...
                const DjotImage({required this.src ,required this.alt ,this.title ,this.attributes ,});
        ...
        @override
        int get hashCode => src.hashCode^alt.hashCode^title.hashCode^attributes.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is DjotImage &&
                runtimeType == other.runtimeType
                && src == other.src&& alt == other.alt&& title == other.title&& attributes == other.attributes;
...
final String? attributes;
                ...
                const DjotLink({required this.url ,required this.text ,this.title ,this.attributes ,});
        ...
        @override
        int get hashCode => url.hashCode^text.hashCode^title.hashCode^attributes.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is DjotLink &&
                runtimeType == other.runtimeType
                && url == other.url&& text == other.text&& title == other.title&& attributes == other.attributes;
...
final Map<String, String>? attributes;
                ...
                const DocumentNode({required this.id ,required this.content ,this.parent ,required this.children ,required this.contentLayer ,this.page ,this.pageEnd ,this.bbox ,required this.annotations ,this.attributes ,});
        ...
        @override
        int get hashCode => id.hashCode^content.hashCode^parent.hashCode^children.hashCode^contentLayer.hashCode^page.hashCode^pageEnd.hashCode^bbox.hashCode^annotations.hashCode^attributes.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is DocumentNode &&
                runtimeType == other.runtimeType
                && id == other.id&& content == other.content&& parent == other.parent&& children == other.children&& contentLayer == other.contentLayer&& page == other.page&& pageEnd == other.pageEnd&& bbox == other.bbox&& annotations == other.annotations&& attributes == other.attributes;
...
final ElementMetadata metadata;
                ...
                const Element({required this.elementId ,required this.elementType ,required this.text ,required this.metadata ,});
        ...
        @override
        int get hashCode => elementId.hashCode^elementType.hashCode^text.hashCode^metadata.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is Element &&
                runtimeType == other.runtimeType
                && elementId == other.elementId&& elementType == other.elementType&& text == other.text&& metadata == other.metadata;
...
@freezed
                sealed class EmbeddingModelType with _$EmbeddingModelType  {
                    const EmbeddingModelType._();
                     ...
                     const factory EmbeddingModelType.preset({   required String name , }) = EmbeddingModelType_Preset;
 const factory EmbeddingModelType.custom({   required String modelId ,  required PlatformInt64 dimensions , }) = EmbeddingModelType_Custom;
 const factory EmbeddingModelType.llm({   required LlmConfig llm , }) = EmbeddingModelType_Llm;
 const factory EmbeddingModelType.plugin({   required String name , }) = EmbeddingModelType_Plugin;
...
final PlatformInt64? clusterId;
                ...
                const ExtractedImage({required this.data ,required this.format ,required this.imageIndex ,this.pageNumber ,this.width ,this.height ,this.colorspace ,this.bitsPerComponent ,required this.isMask ,this.description ,this.ocrResult ,this.boundingBox ,this.sourcePath ,this.imageKind ,this.kindConfidence ,this.clusterId ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ExtractedImage &&
                runtimeType == other.runtimeType
                && data == other.data&& format == other.format&& imageIndex == other.imageIndex&& pageNumber == other.pageNumber&& width == other.width&& height == other.height&& colorspace == other.colorspace&& bitsPerComponent == other.bitsPerComponent&& isMask == other.isMask&& description == other.description&& ocrResult == other.ocrResult&& boundingBox == other.boundingBox&& sourcePath == other.sourcePath&& imageKind == other.imageKind&& kindConfidence == other.kindConfidence&& clusterId == other.clusterId;
...
final String? cancelToken;
                ...
                const ExtractionConfig({required this.useCache ,required this.enableQualityProcessing ,this.ocr ,required this.forceOcr ,this.forceOcrPages ,required this.disableOcr ,this.chunking ,this.contentFilter ,this.images ,this.pdfOptions ,this.tokenReduction ,this.languageDetection ,this.pages ,this.keywords ,this.postprocessor ,this.htmlOptions ,this.htmlOutput ,this.extractionTimeoutSecs ,this.maxConcurrentExtractions ,required this.resultFormat ,this.securityLimits ,required this.outputFormat ,this.layout ,required this.includeDocumentStructure ,this.acceleration ,this.cacheNamespace ,this.cacheTtlSecs ,this.email ,this.concurrency ,required this.maxArchiveDepth ,this.treeSitter ,this.structuredExtraction ,this.cancelToken ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is ExtractionConfig &&
                runtimeType == other.runtimeType
                && useCache == other.useCache&& enableQualityProcessing == other.enableQualityProcessing&& ocr == other.ocr&& forceOcr == other.forceOcr&& forceOcrPages == other.forceOcrPages&& disableOcr == other.disableOcr&& chunking == other.chunking&& contentFilter == other.contentFilter&& images == other.images&& pdfOptions == other.pdfOptions&& tokenReduction == other.tokenReduction&& languageDetection == other.languageDetection&& pages == other.pages&& keywords == other.keywords&& postprocessor == other.postprocessor&& htmlOptions == other.htmlOptions&& htmlOutput == other.htmlOutput&& extractionTimeoutSecs == other.extractionTimeoutSecs&& maxConcurrentExtractions == other.maxConcurrentExtractions&& resultFormat == other.resultFormat&& securityLimits == other.securityLimits&& outputFormat == other.outputFormat&& layout == other.layout&& includeDocumentStructure == other.includeDocumentStructure&& acceleration == other.acceleration&& cacheNamespace == other.cacheNamespace&& cacheTtlSecs == other.cacheTtlSecs&& email == other.email&& concurrency == other.concurrency&& maxArchiveDepth == other.maxArchiveDepth&& treeSitter == other.treeSitter&& structuredExtraction == other.structuredExtraction&& cancelToken == other.cancelToken;
...
final StructuredExtractionConfig? structuredExtraction;
        ...
        @override
        int get hashCode => enableQualityProcessing.hashCode^ocr.hashCode^forceOcr.hashCode^forceOcrPages.hashCode^disableOcr.hashCode^chunking.hashCode^contentFilter.hashCode^images.hashCode^pdfOptions.hashCode^tokenReduction.hashCode^languageDetection.hashCode^pages.hashCode^keywords.hashCode^postprocessor.hashCode^htmlOptions.hashCode^resultFormat.hashCode^outputFormat.hashCode^includeDocumentStructure.hashCode^layout.hashCode^timeoutSecs.hashCode^treeSitter.hashCode^structuredExtraction.hashCode;
...
@freezed
                sealed class FormatMetadata with _$FormatMetadata  {
                    const FormatMetadata._();
                     ...
                     const factory FormatMetadata.pdf({   required String field0 , }) = FormatMetadata_Pdf;
 ...
 const factory FormatMetadata.image({   required String field0 , }) = FormatMetadata_Image;
 ...
 const factory FormatMetadata.code({   required String field0 , }) = FormatMetadata_Code;
...
final List<FormattedBlock> children;
                ...
                const FormattedBlock({required this.blockType ,this.level ,required this.inlineContent ,this.attributes ,this.language ,this.code ,required this.children ,});
        ...
        @override
        int get hashCode => blockType.hashCode^level.hashCode^inlineContent.hashCode^attributes.hashCode^language.hashCode^code.hashCode^children.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is FormattedBlock &&
                runtimeType == other.runtimeType
                && blockType == other.blockType&& level == other.level&& inlineContent == other.inlineContent&& attributes == other.attributes&& language == other.language&& code == other.code&& children == other.children;
...
final Float64List? bbox;
                ...
                const HierarchicalBlock({required this.text ,required this.fontSize ,required this.level ,this.bbox ,});
        ...
        @override
        int get hashCode => text.hashCode^fontSize.hashCode^level.hashCode^bbox.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is HierarchicalBlock &&
                runtimeType == other.runtimeType
                && text == other.text&& fontSize == other.fontSize&& level == other.level&& bbox == other.bbox;
...
final bool classify;
                ...
                const ImageExtractionConfig({required this.extractImages ,required this.targetDpi ,required this.maxImageDimension ,required this.injectPlaceholders ,required this.autoAdjustDpi ,required this.minDpi ,required this.maxDpi ,this.maxImagesPerPage ,required this.classify ,});
        ...
        @override
        int get hashCode => extractImages.hashCode^targetDpi.hashCode^maxImageDimension.hashCode^injectPlaceholders.hashCode^autoAdjustDpi.hashCode^minDpi.hashCode^maxDpi.hashCode^maxImagesPerPage.hashCode^classify.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ImageExtractionConfig &&
                runtimeType == other.runtimeType
                && extractImages == other.extractImages&& targetDpi == other.targetDpi&& maxImageDimension == other.maxImageDimension&& injectPlaceholders == other.injectPlaceholders&& autoAdjustDpi == other.autoAdjustDpi&& minDpi == other.minDpi&& maxDpi == other.maxDpi&& maxImagesPerPage == other.maxImagesPerPage&& classify == other.classify;
...
final List<String> attributes;
                ...
                const ImageMetadataType({required this.src ,this.alt ,this.title ,this.dimensions ,required this.imageType ,required this.attributes ,});
...
final String? resizeError;
                ...
                const ImagePreprocessingMetadata({required this.originalDimensions ,required this.originalDpi ,required this.targetDpi ,required this.scaleFactor ,required this.autoAdjusted ,required this.finalDpi ,this.newDimensions ,required this.resampleMethod ,required this.dimensionClamped ,this.calculatedDpi ,required this.skippedResize ,this.resizeError ,});
        ...
        @override
        int get hashCode => originalDimensions.hashCode^originalDpi.hashCode^targetDpi.hashCode^scaleFactor.hashCode^autoAdjusted.hashCode^finalDpi.hashCode^newDimensions.hashCode^resampleMethod.hashCode^dimensionClamped.hashCode^calculatedDpi.hashCode^skippedResize.hashCode^resizeError.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ImagePreprocessingMetadata &&
                runtimeType == other.runtimeType
                && originalDimensions == other.originalDimensions&& originalDpi == other.originalDpi&& targetDpi == other.targetDpi&& scaleFactor == other.scaleFactor&& autoAdjusted == other.autoAdjusted&& finalDpi == other.finalDpi&& newDimensions == other.newDimensions&& resampleMethod == other.resampleMethod&& dimensionClamped == other.dimensionClamped&& calculatedDpi == other.calculatedDpi&& skippedResize == other.skippedResize&& resizeError == other.resizeError;
...
final Map<String, String>? metadata;
                ...
                const InlineElement({required this.elementType ,required this.content ,this.attributes ,this.metadata ,});
        ...
        @override
        int get hashCode => elementType.hashCode^content.hashCode^attributes.hashCode^metadata.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is InlineElement &&
                runtimeType == other.runtimeType
                && elementType == other.elementType&& content == other.content&& attributes == other.attributes&& metadata == other.metadata;
...
final RakeParams? rakeParams;
                ...
                const KeywordConfig({required this.algorithm ,required this.maxKeywords ,required this.minScore ,required this.ngramRange ,this.language ,this.yakeParams ,this.rakeParams ,});
        ...
        @override
        int get hashCode => algorithm.hashCode^maxKeywords.hashCode^minScore.hashCode^ngramRange.hashCode^language.hashCode^yakeParams.hashCode^rakeParams.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is KeywordConfig &&
                runtimeType == other.runtimeType
                && algorithm == other.algorithm&& maxKeywords == other.maxKeywords&& minScore == other.minScore&& ngramRange == other.ngramRange&& language == other.language&& yakeParams == other.yakeParams&& rakeParams == other.rakeParams;
...
final Map<String, String> additional;
        ...
        @override
        int get hashCode => title.hashCode^subject.hashCode^authors.hashCode^keywords.hashCode^language.hashCode^createdAt.hashCode^modifiedAt.hashCode^createdBy.hashCode^modifiedBy.hashCode^pages.hashCode^format.hashCode^imagePreprocessing.hashCode^jsonSchema.hashCode^error.hashCode^extractionDurationMs.hashCode^category.hashCode^tags.hashCode^documentVersion.hashCode^abstractText.hashCode^outputFormat.hashCode^additional.hashCode;
...
@freezed
 ...
 const factory NodeContent.heading({   required PlatformInt64 level ,  required String text , }) = NodeContent_Heading;
 const factory NodeContent.paragraph({   required String text , }) = NodeContent_Paragraph;
 const factory NodeContent.list({   required bool ordered , }) = NodeContent_List;
 const factory NodeContent.listItem({   required String text , }) = NodeContent_ListItem;
 const factory NodeContent.table({   required TableGrid grid , }) = NodeContent_Table;
 const factory NodeContent.image({   required String description ,  required PlatformInt64 imageIndex ,  required String src , }) = NodeContent_Image;
 const factory NodeContent.code({   required String text ,  required String language , }) = NodeContent_Code;
 const factory NodeContent.quote() = NodeContent_Quote;
 const factory NodeContent.formula({   required String text , }) = NodeContent_Formula;
 const factory NodeContent.footnote({   required String text , }) = NodeContent_Footnote;
 const factory NodeContent.group({   required String label ,  required PlatformInt64 headingLevel ,  required String headingText , }) = NodeContent_Group;
 const factory NodeContent.pageBreak() = NodeContent_PageBreak;
 const factory NodeContent.slide({   required PlatformInt64 number ,  required String title , }) = NodeContent_Slide;
 const factory NodeContent.definitionList() = NodeContent_DefinitionList;
 const factory NodeContent.definitionItem({   required String term ,  required String definition , }) = NodeContent_DefinitionItem;
 const factory NodeContent.citation({   required String key ,  required String text , }) = NodeContent_Citation;
 const factory NodeContent.admonition({   required String kind ,  required String title , }) = NodeContent_Admonition;
 const factory NodeContent.rawBlock({   required String format ,  required String content , }) = NodeContent_RawBlock;
 const factory NodeContent.metadataBlock({   required List<String> entries , }) = NodeContent_MetadataBlock;
...
@freezed
                sealed class OcrBoundingGeometry with _$OcrBoundingGeometry  {
                    const OcrBoundingGeometry._();
                     ...
                     const factory OcrBoundingGeometry.rectangle({   required PlatformInt64 left ,  required PlatformInt64 top ,  required PlatformInt64 width ,  required PlatformInt64 height , }) = OcrBoundingGeometry_Rectangle;
 const factory OcrBoundingGeometry.quadrilateral({   required String points , }) = OcrBoundingGeometry_Quadrilateral;
...
final AccelerationConfig? acceleration;
                ...
                const OcrConfig({required this.enabled ,required this.backend ,required this.language ,this.tesseractConfig ,this.outputFormat ,this.paddleOcrConfig ,this.elementConfig ,this.qualityThresholds ,this.pipeline ,required this.autoRotate ,this.vlmConfig ,this.vlmPrompt ,this.acceleration ,});
        ...
        @override
        int get hashCode => enabled.hashCode^backend.hashCode^language.hashCode^tesseractConfig.hashCode^outputFormat.hashCode^paddleOcrConfig.hashCode^elementConfig.hashCode^qualityThresholds.hashCode^pipeline.hashCode^autoRotate.hashCode^vlmConfig.hashCode^vlmPrompt.hashCode^acceleration.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is OcrConfig &&
                runtimeType == other.runtimeType
                && enabled == other.enabled&& backend == other.backend&& language == other.language&& tesseractConfig == other.tesseractConfig&& outputFormat == other.outputFormat&& paddleOcrConfig == other.paddleOcrConfig&& elementConfig == other.elementConfig&& qualityThresholds == other.qualityThresholds&& pipeline == other.pipeline&& autoRotate == other.autoRotate&& vlmConfig == other.vlmConfig&& vlmPrompt == other.vlmPrompt&& acceleration == other.acceleration;
...
final LlmConfig? vlmConfig;
                ...
                const OcrPipelineStage({required this.backend ,required this.priority ,this.language ,this.tesseractConfig ,this.paddleOcrConfig ,this.vlmConfig ,});
        ...
        @override
        int get hashCode => backend.hashCode^priority.hashCode^language.hashCode^tesseractConfig.hashCode^paddleOcrConfig.hashCode^vlmConfig.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is OcrPipelineStage &&
                runtimeType == other.runtimeType
                && backend == other.backend&& priority == other.priority&& language == other.language&& tesseractConfig == other.tesseractConfig&& paddleOcrConfig == other.paddleOcrConfig&& vlmConfig == other.vlmConfig;
...
final List<LayoutRegion>? layoutRegions;
                ...
                const PageContent({required this.pageNumber ,required this.content ,required this.tables ,required this.images ,this.hierarchy ,this.isBlank ,this.layoutRegions ,});
        ...
        @override
        int get hashCode => pageNumber.hashCode^content.hashCode^tables.hashCode^images.hashCode^hierarchy.hashCode^isBlank.hashCode^layoutRegions.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is PageContent &&
                runtimeType == other.runtimeType
                && pageNumber == other.pageNumber&& content == other.content&& tables == other.tables&& images == other.images&& hierarchy == other.hierarchy&& isBlank == other.isBlank&& layoutRegions == other.layoutRegions;
...
final bool hasVectorGraphics;
                ...
                const PageInfo({required this.number ,this.title ,this.dimensions ,this.imageCount ,this.tableCount ,this.hidden ,this.isBlank ,required this.hasVectorGraphics ,});
        ...
        @override
        int get hashCode => number.hashCode^title.hashCode^dimensions.hashCode^imageCount.hashCode^tableCount.hashCode^hidden.hashCode^isBlank.hashCode^hasVectorGraphics.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is PageInfo &&
                runtimeType == other.runtimeType
                && number == other.number&& title == other.title&& dimensions == other.dimensions&& imageCount == other.imageCount&& tableCount == other.tableCount&& hidden == other.hidden&& isBlank == other.isBlank&& hasVectorGraphics == other.hasVectorGraphics;
...
final bool allowSingleColumnTables;
                ...
                const PdfConfig({required this.extractImages ,this.passwords ,required this.extractMetadata ,this.hierarchy ,required this.extractAnnotations ,this.topMarginFraction ,this.bottomMarginFraction ,required this.allowSingleColumnTables ,});
        ...
        @override
        int get hashCode => extractImages.hashCode^passwords.hashCode^extractMetadata.hashCode^hierarchy.hashCode^extractAnnotations.hashCode^topMarginFraction.hashCode^bottomMarginFraction.hashCode^allowSingleColumnTables.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is PdfConfig &&
                runtimeType == other.runtimeType
                && extractImages == other.extractImages&& passwords == other.passwords&& extractMetadata == other.extractMetadata&& hierarchy == other.hierarchy&& extractAnnotations == other.extractAnnotations&& topMarginFraction == other.topMarginFraction&& bottomMarginFraction == other.bottomMarginFraction&& allowSingleColumnTables == other.allowSingleColumnTables;
...
final List<String>? codeBlocks;
                ...
                const TextMetadata({required this.lineCount ,required this.wordCount ,required this.characterCount ,this.headers ,this.links ,this.codeBlocks ,});
        ...
        @override
        int get hashCode => lineCount.hashCode^wordCount.hashCode^characterCount.hashCode^headers.hashCode^links.hashCode^codeBlocks.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is TextMetadata &&
                runtimeType == other.runtimeType
                && lineCount == other.lineCount&& wordCount == other.wordCount&& characterCount == other.characterCount&& headers == other.headers&& links == other.links&& codeBlocks == other.codeBlocks;
