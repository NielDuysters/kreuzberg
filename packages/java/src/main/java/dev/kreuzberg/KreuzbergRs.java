...
// alef:hash:3259efc7908d286a07e1493cee7e76cd90a5504ae4402d4fba719198e3deba5d
...
public final class KreuzbergRs {
    ...
    public static void clearEmbeddingBackends() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_EMBEDDING_BACKEND.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
    ...
    public static void clearDocumentExtractors() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_DOCUMENT_EXTRACTOR.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
    ...
    public static void clearOcrBackends() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_OCR_BACKEND.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
    ...
    public static void clearPostProcessors() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_POST_PROCESSOR.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
    ...
    public static void clearRenderers() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_RENDERER.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
    ...
    public static void clearValidators() throws KreuzbergRsException {
        try (var arena = Arena.ofShared()) {
            NativeLib.KREUZBERG_CLEAR_VALIDATOR.invoke();
            checkLastError();
        } catch (Throwable e) {
            throw new KreuzbergRsException("FFI call failed", e);
        }
