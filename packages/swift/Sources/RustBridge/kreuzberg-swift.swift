...
public func accelerationConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> AccelerationConfig {
  try {
    let val = __swift_bridge__$acceleration_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return AccelerationConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func contentFilterConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ContentFilterConfig {
  try {
    let val = __swift_bridge__$content_filter_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ContentFilterConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func emailConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EmailConfig {
  try {
    let val = __swift_bridge__$email_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return EmailConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func fileExtractionConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> FileExtractionConfig {
  try {
    let val = __swift_bridge__$file_extraction_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FileExtractionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func imageExtractionConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ImageExtractionConfig {
  try {
    let val = __swift_bridge__$image_extraction_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImageExtractionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func tokenReductionOptionsFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TokenReductionOptions {
  try {
    let val = __swift_bridge__$token_reduction_options_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TokenReductionOptions(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func languageDetectionConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> LanguageDetectionConfig {
  try {
    let val = __swift_bridge__$language_detection_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LanguageDetectionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func htmlOutputConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> HtmlOutputConfig {
  try {
    let val = __swift_bridge__$html_output_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HtmlOutputConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func layoutDetectionConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> LayoutDetectionConfig {
  try {
    let val = __swift_bridge__$layout_detection_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LayoutDetectionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func llmConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> LlmConfig
{
  try {
    let val = __swift_bridge__$llm_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LlmConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func ocrQualityThresholdsFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrQualityThresholds {
  try {
    let val = __swift_bridge__$ocr_quality_thresholds_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrQualityThresholds(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func pageConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> PageConfig
{
  try {
    let val = __swift_bridge__$page_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pdfConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> PdfConfig
{
  try {
    let val = __swift_bridge__$pdf_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PdfConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func hierarchyConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> HierarchyConfig {
  try {
    let val = __swift_bridge__$hierarchy_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HierarchyConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func postProcessorConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PostProcessorConfig {
  try {
    let val = __swift_bridge__$post_processor_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PostProcessorConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func chunkingConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ChunkingConfig {
  try {
    let val = __swift_bridge__$chunking_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ChunkingConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func treeSitterConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TreeSitterConfig {
  try {
    let val = __swift_bridge__$tree_sitter_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TreeSitterConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func treeSitterProcessConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TreeSitterProcessConfig {
  try {
    let val = __swift_bridge__$tree_sitter_process_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TreeSitterProcessConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func serverConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ServerConfig {
  try {
    let val = __swift_bridge__$server_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ServerConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func docxAppPropertiesFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DocxAppProperties {
  try {
    let val = __swift_bridge__$docx_app_properties_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DocxAppProperties(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func xlsxAppPropertiesFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> XlsxAppProperties {
  try {
    let val = __swift_bridge__$xlsx_app_properties_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return XlsxAppProperties(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pptxAppPropertiesFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PptxAppProperties {
  try {
    let val = __swift_bridge__$pptx_app_properties_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PptxAppProperties(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func corePropertiesFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CoreProperties {
  try {
    let val = __swift_bridge__$core_properties_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CoreProperties(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func securityLimitsFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> SecurityLimits {
  try {
    let val = __swift_bridge__$security_limits_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return SecurityLimits(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func tokenReductionConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TokenReductionConfig {
  try {
    let val = __swift_bridge__$token_reduction_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TokenReductionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func tableGridFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> TableGrid
{
  try {
    let val = __swift_bridge__$table_grid_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TableGrid(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func llmUsageFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> LlmUsage
{
  try {
    let val = __swift_bridge__$llm_usage_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LlmUsage(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func ocrTableBoundingBoxFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrTableBoundingBox {
  try {
    let val = __swift_bridge__$ocr_table_bounding_box_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrTableBoundingBox(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func imagePreprocessingConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ImagePreprocessingConfig {
  try {
    let val = __swift_bridge__$image_preprocessing_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImagePreprocessingConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func tesseractConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TesseractConfig {
  try {
    let val = __swift_bridge__$tesseract_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TesseractConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func metadataFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Metadata
{
  try {
    let val = __swift_bridge__$metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Metadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func excelMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ExcelMetadata {
  try {
    let val = __swift_bridge__$excel_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ExcelMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func emailMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EmailMetadata {
  try {
    let val = __swift_bridge__$email_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return EmailMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func archiveMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ArchiveMetadata {
  try {
    let val = __swift_bridge__$archive_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ArchiveMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func xmlMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> XmlMetadata {
  try {
    let val = __swift_bridge__$xml_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return XmlMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func textMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TextMetadata {
  try {
    let val = __swift_bridge__$text_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TextMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func ocrMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrMetadata {
  try {
    let val = __swift_bridge__$ocr_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func pptxMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PptxMetadata {
  try {
    let val = __swift_bridge__$pptx_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PptxMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func docxMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DocxMetadata {
  try {
    let val = __swift_bridge__$docx_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DocxMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func csvMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CsvMetadata {
  try {
    let val = __swift_bridge__$csv_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CsvMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func bibtexMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BibtexMetadata {
  try {
    let val = __swift_bridge__$bibtex_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BibtexMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func citationMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CitationMetadata {
  try {
    let val = __swift_bridge__$citation_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CitationMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func fictionBookMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> FictionBookMetadata {
  try {
    let val = __swift_bridge__$fiction_book_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FictionBookMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func dbfMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> DbfMetadata {
  try {
    let val = __swift_bridge__$dbf_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return DbfMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func jatsMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> JatsMetadata {
  try {
    let val = __swift_bridge__$jats_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return JatsMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func epubMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EpubMetadata {
  try {
    let val = __swift_bridge__$epub_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return EpubMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pstMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PstMetadata {
  try {
    let val = __swift_bridge__$pst_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PstMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrConfidenceFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrConfidence {
  try {
    let val = __swift_bridge__$ocr_confidence_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrConfidence(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrRotationFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrRotation {
  try {
    let val = __swift_bridge__$ocr_rotation_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrRotation(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrElementFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> OcrElement
{
  try {
    let val = __swift_bridge__$ocr_element_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrElement(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrElementConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrElementConfig {
  try {
    let val = __swift_bridge__$ocr_element_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrElementConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func pageBoundaryFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PageBoundary {
  try {
    let val = __swift_bridge__$page_boundary_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageBoundary(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func layoutRegionFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> LayoutRegion {
  try {
    let val = __swift_bridge__$layout_region_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LayoutRegion(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func tableFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Table
{
  try {
    let val = __swift_bridge__$table_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Table(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func tableCellFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> TableCell
{
  try {
    let val = __swift_bridge__$table_cell_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TableCell(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func yakeParamsFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> YakeParams
{
  try {
    let val = __swift_bridge__$yake_params_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return YakeParams(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func rakeParamsFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> RakeParams
{
  try {
    let val = __swift_bridge__$rake_params_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return RakeParams(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func keywordConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> KeywordConfig {
  try {
    let val = __swift_bridge__$keyword_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return KeywordConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func paddleOcrConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PaddleOcrConfig {
  try {
    let val = __swift_bridge__$paddle_ocr_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PaddleOcrConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
public func orientationResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OrientationResult {
  try {
    let val = __swift_bridge__$orientation_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OrientationResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func bBoxFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> BBox
{
  try {
    let val = __swift_bridge__$b_box_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
      }())
    if val.is_ok { return BBox(ptr: val.ok_or_err!) } else { throw RustString(ptr: val.ok_or_err!) }
  }()
}
...
public func pdfMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PdfMetadata {
  try {
    let val = __swift_bridge__$pdf_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PdfMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func executionProviderTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ExecutionProviderType {
  try {
    let val = __swift_bridge__$execution_provider_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ExecutionProviderType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func outputFormatFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OutputFormat {
  try {
    let val = __swift_bridge__$output_format_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OutputFormat(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func htmlThemeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> HtmlTheme
{
  try {
    let val = __swift_bridge__$html_theme_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return HtmlTheme(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func tableModelFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> TableModel
{
  try {
    let val = __swift_bridge__$table_model_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TableModel(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func chunkerTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ChunkerType {
  try {
    let val = __swift_bridge__$chunker_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ChunkerType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func chunkSizingFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ChunkSizing {
  try {
    let val = __swift_bridge__$chunk_sizing_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ChunkSizing(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func embeddingModelTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> EmbeddingModelType {
  try {
    let val = __swift_bridge__$embedding_model_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return EmbeddingModelType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func codeContentModeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CodeContentMode {
  try {
    let val = __swift_bridge__$code_content_mode_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CodeContentMode(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrBackendTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrBackendType {
  try {
    let val = __swift_bridge__$ocr_backend_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrBackendType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func processingStageFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ProcessingStage {
  try {
    let val = __swift_bridge__$processing_stage_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ProcessingStage(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func reductionLevelFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ReductionLevel {
  try {
    let val = __swift_bridge__$reduction_level_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ReductionLevel(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pdfAnnotationTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PdfAnnotationType {
  try {
    let val = __swift_bridge__$pdf_annotation_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PdfAnnotationType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func blockTypeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> BlockType
{
  try {
    let val = __swift_bridge__$block_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BlockType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func inlineTypeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> InlineType
{
  try {
    let val = __swift_bridge__$inline_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return InlineType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func relationshipKindFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> RelationshipKind {
  try {
    let val = __swift_bridge__$relationship_kind_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return RelationshipKind(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func contentLayerFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ContentLayer {
  try {
    let val = __swift_bridge__$content_layer_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ContentLayer(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func nodeContentFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> NodeContent {
  try {
    let val = __swift_bridge__$node_content_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return NodeContent(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func annotationKindFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> AnnotationKind {
  try {
    let val = __swift_bridge__$annotation_kind_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return AnnotationKind(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func extractionMethodFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ExtractionMethod {
  try {
    let val = __swift_bridge__$extraction_method_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ExtractionMethod(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func chunkTypeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> ChunkType
{
  try {
    let val = __swift_bridge__$chunk_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ChunkType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func imageKindFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> ImageKind
{
  try {
    let val = __swift_bridge__$image_kind_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImageKind(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func resultFormatFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ResultFormat {
  try {
    let val = __swift_bridge__$result_format_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ResultFormat(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func elementTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ElementType {
  try {
    let val = __swift_bridge__$element_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ElementType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func formatMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> FormatMetadata {
  try {
    let val = __swift_bridge__$format_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FormatMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func textDirectionFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> TextDirection {
  try {
    let val = __swift_bridge__$text_direction_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return TextDirection(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func linkTypeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> LinkType
{
  try {
    let val = __swift_bridge__$link_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LinkType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func imageTypeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> ImageType
{
  try {
    let val = __swift_bridge__$image_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ImageType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func structuredDataTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> StructuredDataType {
  try {
    let val = __swift_bridge__$structured_data_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return StructuredDataType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrBoundingGeometryFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrBoundingGeometry {
  try {
    let val = __swift_bridge__$ocr_bounding_geometry_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrBoundingGeometry(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func ocrElementLevelFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OcrElementLevel {
  try {
    let val = __swift_bridge__$ocr_element_level_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OcrElementLevel(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func pageUnitTypeFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PageUnitType {
  try {
    let val = __swift_bridge__$page_unit_type_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PageUnitType(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func uriKindFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> UriKind
{
  try {
    let val = __swift_bridge__$uri_kind_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return UriKind(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func keywordAlgorithmFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> KeywordAlgorithm {
  try {
    let val = __swift_bridge__$keyword_algorithm_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return KeywordAlgorithm(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func psmModeFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> PSMMode
{
  try {
    let val = __swift_bridge__$psm_mode_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PSMMode(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func paddleLanguageFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> PaddleLanguage {
  try {
    let val = __swift_bridge__$paddle_language_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return PaddleLanguage(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func layoutClassFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> LayoutClass {
  try {
    let val = __swift_bridge__$layout_class_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LayoutClass(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
extension EmailConfigRef {
  public func msgFallbackCodepage() -> UInt32? {
...
extension ExtractionConfigRef {
  ...
  public func forceOcrPages() -> RustVec<UInt32>? {
    {
  ...
  public func contentFilter() -> ContentFilterConfig? {
    {
  ...
  public func pdfOptions() -> PdfConfig? {
    {
  ...
  public func tokenReduction() -> TokenReductionOptions? {
    {
  ...
  public func languageDetection() -> LanguageDetectionConfig? {
    {
  ...
  public func htmlOptions() -> RustString? {
    {
  ...
  public func htmlOutput() -> HtmlOutputConfig? {
    {
  ...
  public func extractionTimeoutSecs() -> UInt64? {
    __swift_bridge__$ExtractionConfig$extraction_timeout_secs(ptr).intoSwiftRepr()
  }

  public func maxConcurrentExtractions() -> UInt? {
  ...
  public func securityLimits() -> SecurityLimits? {
    {
  ...
  public func cacheNamespace() -> RustString? {
    {
  ...
  public func cacheTtlSecs() -> UInt64? {
  ...
  public func treeSitter() -> TreeSitterConfig? {
    {
  ...
  public func structuredExtraction() -> StructuredExtractionConfig? {
    {
  ...
  public func cancelToken() -> RustString? {
    {
...
extension FileExtractionConfigRef {
  ...
  public func timeoutSecs() -> UInt64? {
...
extension ImageExtractionConfigRef {
  ...
  public func maxImagesPerPage() -> UInt32? {
...
extension HtmlOutputConfigRef {
  ...
  public func cssFile() -> RustString? {
    {
...
extension LayoutDetectionConfigRef {
  public func confidenceThreshold() -> Float? {
...
extension StructuredExtractionConfigRef {
  ...
  public func schemaDescription() -> RustString? {
    {
...
extension OcrPipelineStageRef {
  ...
  public func tesseractConfig() -> TesseractConfig? {
    {
  ...
  public func paddleOcrConfig() -> RustString? {
    {
  ...
  public func vlmConfig() -> LlmConfig? {
    {
  ...
  public func backendOptions() -> RustString? {
    {
...
extension OcrConfigRef {
  ...
  public func elementConfig() -> OcrElementConfig? {
    {
  ...
  public func vlmPrompt() -> RustString? {
    {
...
extension PdfConfigRef {
  ...
  public func topMarginFraction() -> Float? {
    __swift_bridge__$PdfConfig$top_margin_fraction(ptr).intoSwiftRepr()
  }

  public func bottomMarginFraction() -> Float? {
...
extension HierarchyConfigRef {
  ...
  public func ocrCoverageThreshold() -> Float? {
...
extension PostProcessorConfigRef {
  ...
  public func enabledProcessors() -> RustVec<RustString>? {
    {
  ...
  public func disabledProcessors() -> RustVec<RustString>? {
    {
  ...
  public func enabledSet() -> RustVec<RustString>? {
    {
  ...
  public func disabledSet() -> RustVec<RustString>? {
    {
...
extension ChunkingConfigRef {
  ...
  public func topicThreshold() -> Float? {
...
extension EmbeddingConfigRef {
  ...
  public func cacheDir() -> RustString? {
    {
  ...
  public func maxEmbedDurationSecs() -> UInt64? {
...
extension DocxAppPropertiesRef {
  ...
  public func appVersion() -> RustString? {
    {
  ...
  public func charactersWithSpaces() -> Int32? {
...
extension CorePropertiesRef {
  ...
  public func lastModifiedBy() -> RustString? {
    {
  ...
  public func contentStatus() -> RustString? {
    {
  ...
  public func lastPrinted() -> RustString? {
    {
...
extension TokenReductionConfigRef {
  ...
  public func languageHint() -> RustString? {
    {
  ...
  public func targetReduction() -> Float? {
...
extension DocumentStructureRef {
  ...
  public func sourceFormat() -> RustString? {
    {
...
extension ExtractionResultRef {
  ...
  public func extractionMethod() -> RustString? {
    {
  ...
  public func detectedLanguages() -> RustVec<RustString>? {
    {
  ...
  public func djotContent() -> DjotContent? {
    {
  ...
  public func ocrElements() -> RustVec<OcrElement>? {
    {
  ...
  public func extractedKeywords() -> RustVec<Keyword>? {
    {
  ...
  public func qualityScore() -> Double? {
  ...
  public func structuredOutput() -> RustString? {
    {
  ...
  public func codeIntelligence() -> RustString? {
    {
  ...
  public func llmUsage() -> RustVec<LlmUsage>? {
    {
  ...
  public func formattedContent() -> RustString? {
    {
...
extension LlmUsageRef {
  ...
  public func finishReason() -> RustString? {
    {
...
extension ExtractedImageRef {
  ...
  public func bitsPerComponent() -> UInt32? {
  ...
  public func ocrResult() -> ExtractionResult? {
    {
  ...
  public func sourcePath() -> RustString? {
    {
  ...
  public func imageKind() -> RustString? {
    {
...
extension PptxExtractionResultRef {
  ...
  public func pageStructure() -> PageStructure? {
    {
  ...
  public func pageContents() -> RustVec<PageContent>? {
    {
...
extension EmailExtractionResultRef {
  ...
  public func fromEmail() -> RustString? {
    {
  ...
  public func messageId() -> RustString? {
    {
  ...
  public func htmlContent() -> RustString? {
    {
...
extension OcrTableRef {
  ...
  public func boundingBox() -> OcrTableBoundingBox? {
    {
...
extension ImagePreprocessingMetadataRef {
  ...
  public func newDimensions() -> RustVec<UInt>? {
    {
  ...
  public func calculatedDpi() -> Int32? {
  ...
  public func resizeError() -> RustString? {
    {
...
extension MetadataRef {
  ...
  public func createdAt() -> RustString? {
    {
  ...
  public func modifiedAt() -> RustString? {
    {
  ...
  public func createdBy() -> RustString? {
    {
  ...
  public func modifiedBy() -> RustString? {
    {
  ...
  public func imagePreprocessing() -> ImagePreprocessingMetadata? {
    {
  ...
  public func jsonSchema() -> RustString? {
    {
  ...
  public func extractionDurationMs() -> UInt64? {
  ...
  public func documentVersion() -> RustString? {
    {
  ...
  public func abstractText() -> RustString? {
    {
...
extension ExcelMetadataRef {
  public func sheetCount() -> UInt32? {
    __swift_bridge__$ExcelMetadata$sheet_count(ptr).intoSwiftRepr()
  }

  public func sheetNames() -> RustVec<RustString>? {
    {
...
extension EmailMetadataRef {
  ...
  public func fromName() -> RustString? {
    {
...
extension ArchiveMetadataRef {
  ...
  public func compressedSize() -> UInt64? {
...
extension HtmlMetadataRef {
  ...
  public func canonicalUrl() -> RustString? {
    {
  ...
  public func baseHref() -> RustString? {
    {
  ...
  public func textDirection() -> RustString? {
    {
...
extension DocxMetadataRef {
  public func coreProperties() -> CoreProperties? {
    {
  ...
  public func appProperties() -> DocxAppProperties? {
    {
...
extension CsvMetadataRef {
  ...
  public func columnTypes() -> RustVec<RustString>? {
    {
...
extension BibtexMetadataRef {
  ...
  public func yearRange() -> YearRange? {
    {
...
extension EpubMetadataRef {
  ...
  public func dcFormat() -> RustString? {
    {
  ...
  public func coverImage() -> RustString? {
    {
...
extension OcrElementRef {
  ...
  public func parentId() -> RustString? {
    {
...
extension PageContentRef {
  ...
  public func layoutRegions() -> RustVec<LayoutRegion>? {
    {
...
extension KeywordConfigRef {
  ...
  public func yakeParams() -> YakeParams? {
    {
  ...
  public func rakeParams() -> RakeParams? {
    {
...
extension PdfMetadataRef {
  public func pdfVersion() -> RustString? {
    {
